...
// app.get('/make_appointments', /* connectEnsureLogin.ensureLoggedIn('/patient_login'),*/ async function (req, res, next) {
...
// await appointmentModel.find({}) // try to put sth some value here 
//     .populate("patient")
//         .exec((err, data) => {
//             if (err) {
//                 res.status(500).json({
...
//                     // result: data,
//                     // message: "Success",
//                     res.render("pages/make_appointments", { result: data })
//                 //  });
//             }
//         });
